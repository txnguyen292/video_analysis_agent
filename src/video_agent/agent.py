...
class VideoAgent:
    ...
    def get_summary(self, video_file):
    ...
    def ask_question(self, video_file, question: str):
        """Answers a specific question about the video content."""
        prompt = f"Based on this video, please answer the following question: {question}"
        return self.client.analyze_video(video_file, prompt)

    def detect_events(self, video_file):
    ...
    def transcribe_and_diarize(self, video_file):
