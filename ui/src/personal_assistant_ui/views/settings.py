...
class SettingsView(ft.Column):
    def __init__(self, page: ft.Page):
        ...
        default_model = (
            ui_config.get("model") or core_config.get("model") or "gemini-3-flash"
        )
        ...
        self.controls = [
            ft.Text(
                "Settings", size=28, weight=ft.FontWeight.BOLD, color=theme.TEXT_PRIMARY
            ),
